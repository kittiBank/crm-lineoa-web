...
/**
 * Pagination component for LINE users
 * Handles page navigation with prev/next buttons and page indicators
 */
export function Pagination({
  ...
  return (
    <div className="mt-4 px-6 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center justify-between gap-4">
