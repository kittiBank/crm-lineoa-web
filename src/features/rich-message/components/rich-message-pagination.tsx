...
interface RichMessagePaginationProps {
  currentPage: number;
  totalPages: number;
  totalItems: number;
  itemsPerPage: number;
 ...
 * Displays page navigation and items per page selector (matches templates style)
 */
export function RichMessagePagination({
  currentPage,
  totalPages,
  totalItems,
  itemsPerPage,
    ...
    <div className="mt-3 px-6 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center justify-between gap-4">
      <div className="flex items-center gap-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">
          Showing {startItem}-{endItem} of {totalItems} rich messages
        </p>
      </div>
