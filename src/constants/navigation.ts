...
export const BREADCRUMB_MAP: Record<string, string[]> = {
  ...
  "/templates": ["Message", "Message Template"],
  "/templates/create": ["Message", "Message Template", "Create"],
  "/templates/[id]/edit": ["Message", "Message Template", "Edit"],
  "/templates/[id]/view": ["Message", "Message Template", "View"],
  "/rich-message": ["Message", "Rich Message"],
  "/rich-message/create": ["Message", "Rich Message", "Create"],
  "/rich-message/[id]/edit": ["Message", "Rich Message", "Edit"],
  "/rich-message/[id]/view": ["Message", "Rich Message", "View"],
